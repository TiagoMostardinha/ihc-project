...
const ProfileT2 = () => {
    ...
    const uname = JSON.parse(localStorage.getItem("user"))['uname'];
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gridGap: 20 }}>
                    ...
                    <div>
                        <div className="card-body items-right text-right">
                            <div className="tabs">
                                <a className="tab tab-bordered" href='profile1'>Medical Info</a>
                                <a className="tab tab-bordered tab-active">Personal Info</a>
                            </div>
